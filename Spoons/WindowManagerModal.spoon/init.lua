...
local modalHotkeys = {
    {
        shortcut = {modifiers = {}, key = "up"},
        pressedfn = move,
        repeatfn = move,
        arg = "up",
        txt = "Move Up"
    }, {
        shortcut = {modifiers = {}, key = "down"},
        pressedfn = move,
        repeatfn = move,
        arg = "down",
        txt = "Move Down"
    }, {
        shortcut = {modifiers = {}, key = "left"},
        pressedfn = move,
        repeatfn = move,
        arg = "left",
        txt = "Move Left"
    }, {
        shortcut = {modifiers = {}, key = "right"},
        pressedfn = move,
        repeatfn = move,
        arg = "right",
        txt = "Move Right"
...
function obj:init()
    ...
    for _, binding in ipairs(modalHotkeys) do
        ...
        obj.windowManagerModal:bind(binding.shortcut.modifiers,
                                    binding.shortcut.key,
                                    function() binding.pressedfn(arg) end, nil,
                                    function() binding.repeatfn(arg) end)
    end
