--- === AppSpoonsManager ===
--- Manages the activation and deactivation of the app-specific Spoons
--- when an app goes in and out of focus, respectively.
local spoon = spoon
...
--- Method
--- Calls the `start()` method of the Spoon for the focused app, and calls `exit()` on all other Spoons.
--- This method must be called in each callback of your `hs.application.watcher` instance.
--- Parameters:
