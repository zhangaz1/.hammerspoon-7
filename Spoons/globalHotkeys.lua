...
local appScripts = require("Spoons.appScripts")
local notificationCenter = require("Spoons.notificationCenter")
...
local function moveFocusToMenuBar()
...
Hotkey.bind(
    ...
    "1",
    function()
        notificationCenter:clickButton(1)
    end
)
Hotkey.bind(
    hyper,
    "2",
    function()
        notificationCenter:clickButton(2)
    end
)
Hotkey.bind(
    hyper,
...
Hotkey.bind(
    ...
    "up",
    function()
        spoon.WindowManager.pushToCell("Up")
    end
)
Hotkey.bind(
    hyper,
    "down",
    function()
        spoon.WindowManager.pushToCell("Down")
    end
)
Hotkey.bind(
    hyper,
    "right",
    function()
        spoon.WindowManager.pushToCell("Right")
    end
)
Hotkey.bind(
    hyper,
    "left",
    function()
        spoon.WindowManager.pushToCell("Left")
    end
)
Hotkey.bind(
    hyper,
