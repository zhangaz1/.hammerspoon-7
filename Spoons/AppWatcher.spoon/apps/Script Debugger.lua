...
m.modal:bind(
  ...
  "1",
  function()
    ui.getUIElement(m.thisApp, m.uiPane1):setAttributeValue("AXFocused", true)
  end
)
m.modal:bind(
  {"alt"},
  "2",
  function()
    ui.getUIElement(m.thisApp, m.uiPane2):setAttributeValue("AXFocused", true)
  end
)
m.modal:bind(
  {"alt"},
  "3",
  function()
    ui.getUIElement(m.thisApp, m.uiPane3):setAttributeValue("AXFocused", true)
  end
)
